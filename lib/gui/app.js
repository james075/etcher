...
app.controller('ApplicationController', function(SupportedFormatsModel, OSDialogService, AnalyticsService, SelectionStateModel) {
   ...
   *   .then(ApplicationController.selectImage);
   */
