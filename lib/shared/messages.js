...
module.exports = {
  ...
  warning: {
    ...
    possiblyWindowsImage: _.template([
      'It looks like you are trying to write a Windows image.',
      'Windows images require special treatment that is not currently built into Etcher in order to be made bootable.',
      'It is recommended to use a specialised tool such as <a href="#" os-open-external="https://rufus.akeo.ie">Rufus</a>',
      'if you\'re trying to write a Windows bootable image.'
    ].join(' '))
