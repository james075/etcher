...
module.exports = {
  ...
  warning: {
    ...
    possiblyWindowsImage: _.template([
      ...
      'Windows images require special treatment to be made bootable.',
      'If you want to write a bootable Windows image, it is recommended that you use a different image burning tool.'
    ].join(' '))
